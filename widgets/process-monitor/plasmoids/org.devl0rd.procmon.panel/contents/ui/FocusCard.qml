...
PopCard {
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            color: Qt.alpha(root.fpsColor(card.proc ? card.proc.fps : 0), 0.14)
            ColumnLayout {
                id: fpsColumn
                ...
                PlasmaComponents.Label {
                    ...
                    color: root.fpsColor(card.proc ? card.proc.fps : 0)
                }
                PlasmaComponents.Label {
                    Layout.alignment: Qt.AlignHCenter
                    text: i18n("FPS")
    ...
    GridLayout {
        ...
        MetricTile {
            ...
            unit: "%"
            valueColor: root.heatColor(card.proc ? card.proc.cpu : 0)
        ...
        MetricTile {
            ...
            unit: "%"
            valueColor: root.heatColor(card.proc ? card.proc.gpu : 0)
