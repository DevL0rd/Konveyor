...
PlasmoidItem {
    ...
    readonly property bool overlayHost: Plasmoid.pluginName === "org.devl0rd.sysmon.overlay"
    ...
    function metric(key, label, keywords, get, fmt, max, warn, crit) {
        return {
            ...
            color: warn === undefined ? undefined : function(v, theme) { return Style.heatStrong(v, warn, crit, theme || Kirigami.Theme) }
        }
    }
