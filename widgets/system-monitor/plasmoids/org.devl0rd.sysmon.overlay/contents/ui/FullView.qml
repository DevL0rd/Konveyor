        ...
        PopupShell {
            ...
            PopScroll {
                ...
                PopCard {
                    ...
                    trailingColor: cpuTabs.current.color ? cpuTabs.current.color(cpuTabs.current.get(root.cpu), Kirigami.Theme) : Kirigami.Theme.textColor
                ...
                PopCard {
                    ...
                    trailingColor: root.gpu && gpuTabs.current.color ? gpuTabs.current.color(gpuTabs.current.get(root.gpu), Kirigami.Theme) : Kirigami.Theme.textColor
