...
ARCH_PACKAGES=(base-devel cmake ninja git extra-cmake-modules qt6-base qt6-declarative kwin kglobalaccel kconfig kcolorscheme knotifications kcoreaddons ki18n libxkbcommon python-dbus kirigami layer-shell-qt kcmutils kirigami-addons kdeclarative kservice)
FEDORA_PACKAGES=(cmake ninja-build git gcc-c++ extra-cmake-modules qt6-qtbase-devel qt6-qtbase-private-devel qt6-qtdeclarative-devel kwin-devel kf6-kglobalaccel-devel kf6-kconfig-devel kf6-kcolorscheme-devel kf6-knotifications-devel kf6-kcoreaddons-devel kf6-ki18n-devel libxkbcommon-devel python3-dbus kf6-kirigami layer-shell-qt kf6-kcmutils-devel kf6-kirigami-addons kf6-kdeclarative kf6-kservice-devel)
SUSE_PACKAGES=(cmake ninja git gcc-c++ kf6-extra-cmake-modules qt6-base-devel qt6-base-private-devel qt6-declarative-devel kwin6-devel kf6-kglobalaccel-devel kf6-kconfig-devel kf6-kcolorscheme-devel kf6-knotifications-devel kf6-kcoreaddons-devel kf6-ki18n-devel libxkbcommon-devel python3-dbus-python kf6-kirigami layer-shell-qt6 kf6-kcmutils-devel kf6-kcmutils-imports kirigami-addons6 kf6-kdeclarative-imports kf6-kservice-devel)
DEBIAN_PACKAGES=(cmake ninja-build git g++ extra-cmake-modules qt6-base-dev qt6-base-private-dev qt6-declarative-dev kwin-dev libkf6globalaccel-dev libkf6config-dev libkf6colorscheme-dev libkf6notifications-dev libkf6coreaddons-dev libkf6i18n-dev libxkbcommon-dev python3-dbus qml6-module-org-kde-kirigami qml6-module-org-kde-layershell libkf6kcmutils-dev qml6-module-org-kde-kcmutils qml6-module-org-kde-kirigamiaddons-formcard qml6-module-org-kde-kquickcontrols libkf6service-dev)
