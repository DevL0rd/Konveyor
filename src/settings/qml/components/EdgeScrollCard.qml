...
Card {
    ...
    SliderRow {
        ...
        onEdited: value => SettingsStore.setValue(card.path + "/" + card.triggerName, [Math.round(value)])
    }
    ...
    SliderRow {
        ...
        onEdited: value => SettingsStore.setValue(card.path + "/delay-ms", [Math.round(value)])
    }
    ...
    SliderRow {
        ...
        onEdited: value => SettingsStore.setValue(card.path + "/max-speed", [Math.round(value)])
    }
}
