...
ColumnLayout {
    ...
    readonly property var result: SettingsStore.revision >= 0 && SettingsStore.live.windows ? SettingsStore.checkRule(SettingsStore.node(rulePath)) : ({})
    ...
    RowLayout {
        ...
        QQC2.Label {
            Layout.fillWidth: true
            wrapMode: Text.Wrap
            text: !SettingsStore.live.running ? "Konveyor isn't running, so open windows can't be checked."
        ...
        QQC2.ToolButton {
            ...
            onClicked: SettingsStore.live.refresh()
        ...
        Repeater {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Kirigami.Icon {
                        source: SettingsStore.live.iconFor(chip.modelData.app_id || "")
