...
Rectangle {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    implicitHeight: 8
                    radius: 4
                    color: SettingsStore.live.running ? Kirigami.Theme.positiveTextColor : Kirigami.Theme.neutralTextColor
                }

                QQC2.Label {
                    text: SettingsStore.live.running ? "Running" : "Not running"
        ...
        QQC2.Button {
            ...
            onClicked: SettingsStore.openConfigFile()
        }
    }
}
