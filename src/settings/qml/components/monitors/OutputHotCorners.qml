...
ColumnLayout {
    ...
    function toggle(corner) {
        ...
        SettingsStore.setNode(blockPath, { name: "hot-corners", args: [], props: {}, children: children });
    }
    ...
    SwitchRow {
        ...
        onSwitched: on => on ? SettingsStore.remove(editor.blockPath + "/off") : SettingsStore.append(editor.blockPath, { name: "off", args: [], props: {} })
    }
