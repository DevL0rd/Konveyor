    ...
    Card {
        ScopedRow {
            ...
            ValueSlider {
                ...
                to: 64
                unit: "px"
                onEdited: value => LayoutKeys.write(SettingsStore, root.scopePath, "gaps", Math.round(value))
            }
        }
        ...
        ScopedRow {
            ...
            PresetSizeBars {
                ...
                onEdited: sizes => LayoutKeys.write(SettingsStore, root.scopePath, "preset-column-widths", sizes)
            }
        }
        ...
        ScopedRow {
            ...
            PresetSizeBars {
                ...
                onEdited: sizes => LayoutKeys.write(SettingsStore, root.scopePath, "preset-window-heights", sizes)
            }
        }
    }
    ...
    Card {
        ScopedRow {
            ...
            StrutsEditor {
                ...
                onEdited: struts => LayoutKeys.write(SettingsStore, root.scopePath, "struts", struts)
            }
        }
        ...
        ScopedRow {
            ...
            ColorField {
                ...
                onEdited: css => LayoutKeys.write(SettingsStore, root.scopePath, "background-color", css)
            }
        }
    }
}
