...
SettingsPage {
    ...
    readonly property var rule: SettingsStore.revision >= 0 ? SettingsStore.node(rulePath) : ({})
    readonly property var matches: SettingsStore.revision >= 0 ? SettingsStore.children(rulePath, "match") : []
    readonly property var excludes: SettingsStore.revision >= 0 ? SettingsStore.children(rulePath, "exclude") : []
    ...
    Card {
        ...
        ColumnLayout {
            ...
            Kirigami.Heading {
                level: 3
                text: RuleSummary.target(page.rule, appId => SettingsStore.live.nameFor(appId))
                wrapMode: Text.Wrap
                Layout.fillWidth: true
            }
    ...
    Card {
        ...
        QQC2.Button {
            ...
            onClicked: SettingsStore.append(page.rulePath, Kdl.leaf("match"))
        }
    }
    ...
    Card {
        ...
        QQC2.Button {
            ...
            onClicked: SettingsStore.append(page.rulePath, Kdl.leaf("exclude"))
        }
    }
    ...
    QQC2.Button {
        ...
        onClicked: {
            SettingsStore.remove(page.rulePath);
