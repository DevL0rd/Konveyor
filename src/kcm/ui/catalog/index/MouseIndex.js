...
const entries = [
    ...
    { page: "mouse", section: "Scrolling while dragging", label: "Switch workspaces", keywords: "drag and drop edge workspace switch dnd" },
    { page: "mouse", section: "Scrolling while dragging", label: "Edge width", keywords: "trigger width edge zone" },
    { page: "mouse", section: "Scrolling while dragging", label: "Edge height", keywords: "trigger height edge zone" },
    { page: "mouse", section: "Scrolling while dragging", label: "Wait before scrolling", keywords: "delay ms edge" },
    { page: "mouse", section: "Scrolling while dragging", label: "Top speed", keywords: "max speed scroll edge" }
];
