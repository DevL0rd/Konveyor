    ...
    Card {
        RowLayout {
            ...
            QQC2.ToolButton {
                ...
                onClicked: kcm.move(card.path, -1)
                QQC2.ToolTip.text: text
                QQC2.ToolTip.visible: hovered
            }
            ...
            QQC2.ToolButton {
                ...
                display: QQC2.AbstractButton.IconOnly
                text: "Remove"
                onClicked: kcm.remove(card.path)
                QQC2.ToolTip.text: text
                QQC2.ToolTip.visible: hovered
            }
        }
        ...
        SettingRow {
            ...
            OutputPicker {
                value: card.output
                allowNone: true
                onPicked: name => name.length ? kcm.setValue(card.path + "/open-on-output", [name]) : kcm.remove(card.path + "/open-on-output")
            }
        }
