...
SettingsPage {
    ...
    readonly property string modKey: kcm.values["input/mod-key"] || "Super"
    readonly property var binds: kcm.revision >= 0 ? (kcm.node("binds").children || []) : []
        ...
        SettingRow {
            ...
            ColumnLayout {
                ...
                ModKeyPicker {
                    ...
                    value: page.modKey
                    onPicked: name => kcm.setValue("input/mod-key", [name])
                }
            }
        }
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            QQC2.ToolButton {
                ...
                enabled: kcm.revision >= 0 && !kcm.isDefault("binds")
            ...
            Card {
                Repeater {
                    ...
                    ShortcutRow {
                        ...
                        onRemoveRequested: kcm.remove("binds/" + modelData.name)
                    }
                }
            }
        }
    ...
    Kirigami.PromptDialog {
        ...
        onAccepted: kcm.resetToDefault("binds")
    }
}
