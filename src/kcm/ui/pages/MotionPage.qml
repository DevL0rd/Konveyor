...
SettingsPage {
    ...
    readonly property bool animationsOn: kcm.values["animations/enabled"] === true
    ...
    Card {
        SwitchRow {
            ...
            onSwitched: on => kcm.setToggle("animations", on)
        }
        ...
        SliderRow {
            ...
            highLabel: "Slower"
            value: page.slowdown
            onEdited: value => kcm.setValue("animations/slowdown", [Math.round(value * 10) / 10])
        }
    }
