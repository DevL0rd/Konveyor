...
SettingsPage {
    ...
    readonly property var named: kcm.revision >= 0 ? kcm.children("", "workspace") : []
    ...
    preview: WorkspaceStack {
        ...
        backAndForth: kcm.values["input/workspace-auto-back-and-forth"] === true
    }
    ...
    Card {
        SwitchRow {
            ...
            isOn: kcm.values["input/workspace-auto-back-and-forth"] === true
            onSwitched: on => kcm.setFlag("input/workspace-auto-back-and-forth", on)
        }
        ...
        SwitchRow {
            ...
            onSwitched: on => kcm.setFlag("layout/empty-workspace-above-first", on)
        }
    }
    ...
    WorkspaceNameDialog {
        ...
        onNameChosen: name => {
            if (page.renamePath.length) {
                kcm.setNode(page.renamePath, { name: "workspace", args: [name], props: {} });
            } else {
                kcm.append("", { name: "workspace", args: [name], props: {} });
            }
        }
    }
}
