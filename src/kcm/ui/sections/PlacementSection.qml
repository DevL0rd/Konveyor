    ...
    Card {
        ScopedRow {
            ...
            ChoiceCards {
                ...
                onChosen: value => LayoutKeys.write(kcm, root.scopePath, "new-column-position", value)
                options: [
        ...
        ScopedRow {
            ...
            SizePicker {
                ...
                onEdited: size => LayoutKeys.write(kcm, root.scopePath, "default-column-width", size)
            }
        }
        ...
        ScopedRow {
            ...
            ChoiceCards {
                ...
                onChosen: value => LayoutKeys.write(kcm, root.scopePath, "default-column-display", value)
                options: [
    ...
    Card {
        ScopedRow {
            ...
            ChoiceCards {
                ...
                cardHeight: Kirigami.Units.gridUnit * 7
                onChosen: value => LayoutKeys.write(kcm, root.scopePath, "center-focused-column", value)
                options: [
